...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="section-padding">
        <div className="section-container">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-gradient">Depoimentos Profissionais</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Avaliações de advogados e escritórios que confiam em nosso trabalho técnico
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="testimonial-card">
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground italic">
                  "A precisão técnica do Gustavo é impressionante. Os laudos chegam sempre no prazo, 
                  com formatação perfeita para o PJe e fundamentação jurídica impecável. 
                  Já utilizamos seus serviços em mais de 50 processos sem qualquer inconsistência."
                </p>
                <div className="flex items-center gap-3 pt-4">
                  ...
                  <div>
                    <p className="font-semibold">Dra. Marina Rodrigues</p>
                    <p className="text-sm text-muted-foreground">Sócia - Rodrigues & Associados Advocacia</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="testimonial-card">
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground italic">
                  "Profissional extremamente técnico e confiável. A metodologia estruturada 
                  e a comunicação objetiva fazem toda a diferença. Os cálculos são entregues 
                  com revisão dupla e nunca tivemos problemas com impugnações."
                </p>
                <div className="flex items-center gap-3 pt-4">
                  <div className="w-12 h-12 bg-[hsl(var(--primary))]/10 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <p className="font-semibold">Dr. Roberto Santos</p>
                    <p className="text-sm text-muted-foreground">Coordenador Jurídico - Departamento Trabalhista</p>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <footer className="bg-[hsl(var(--primary))] text-white py-12">
        <div className="section-container">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4">
              <h3 className="text-xl font-semibold">Gustavo Oliveira</h3>
          ...
          <div className="text-center text-white/70 text-sm">
            <p>© 2024 Gustavo Oliveira - Cálculos Trabalhistas. Todos os direitos reservados.</p>
